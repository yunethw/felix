...
class CategoryModel {
    ...
    var categoriesSnapshot = mutableListOf<HashMap<String,JSONObject>>()

    inner class LoadCategories : ValueEventListener{
        ...
        suspend fun getData(): MutableList<HashMap<String, JSONObject>> {
            ...
            return categoriesSnapshot.filterNotNull().toMutableList()
        }
    }
}